...
export default function Header(props) {
  ...
  return (
    <React.Fragment>
      <header className="main-header u-padding-inline-end-0">
        <button
          onClick={toggleMenu}
          className="button is-text is-only-icon is-not-desktop nav-btn"
          aria-label="Open Menu"
        >
          <span aria-hidden="true" className="icon-menu" />
        </button>
        ...
        <div className="main-header-end u-margin-inline-end-16">
          <ul className="buttons-list is-with-padding">
            <li className="buttons-list-item">
              <a
                href="https://github.com/Meldiron/appwrite-ssr-astro"
                target="_blank"
                className="button is-secondary is-not-mobile"
              >
              ...
              <a
                href="https://github.com/Meldiron/appwrite-ssr-astro"
                target="_blank"
                className="button is-secondary is-only-mobile"
              >
                <svg
                  width="16"
                  height="16"
      ...
      <aside
        ...
        style={{
          display:
            isMenuOpened === null ? undefined : isMenuOpened ? "block" : "none",
        }}
      >
        <div className="side-nav">
          <div className="side-nav-main">
              ...
              <ul className="drop-list">
                <li className="drop-list-item">
                  ...
                  >
                    ...
                    <span className="text">Svelte Kit</span>
                  </a>
                </li>
                <li className="drop-list-item">
                  <a
                    className="drop-button u-cross-center"
                    href="https://next-js.ssr.almostapps.eu/"
                  >
                    <svg
                      role="img"
                      width="16"
                ...
                <li className="drop-list-item">
                  <a
                    className="drop-button u-cross-center"
                    href="https://nuxt.ssr.almostapps.eu/"
                  >
                    <svg
                      role="img"
                      width="16"
                ...
                <li className="drop-list-item">
                  <a className="drop-button u-cross-center is-selected" href="https://astro.ssr.almostapps.eu/">
                    <svg
                      role="img"
                      width="16"
                      viewBox="0 0 24 24"
                ...
                <li className="drop-list-item">
                  <a className="drop-button u-cross-center" href="/">
                    ...
                    <span className="text">Analog</span>
                    <code className=" inline-code">WIP</code>
                  </a>
                </li>
              </ul>
            ...
            >
              <div className="u-flex u-cross-center u-flex-vertical u-gap-8">
                <p>
                  Made with{" "}
                  <span
                    style={{
                ...
                <div>
                  <ul className="avatars-group">
                    <li className="avatars-group-item">
                      <a
                        href="https://github.com/matusfercak"
                        target="_blank"
                        className="avatar is-size-small is-color-blue"
                      >
                        <img
                          style={{
                            borderRadius: "50%",
